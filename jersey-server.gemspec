...
Gem::Specification.new do |s|
  ...
  s.summary = %q{A JavaGem version of jersey-server - packaged by JavaGems (http://www.javagems.org) - original by Sun Microsystems, Inc (http://www.sun.com/)}
